...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /** TODO: Class Exercise
         ...
         for regular user, they have to provide their budget as wellfor regular user, menu to choose which car they want from list of cars
         if budget is less than car price, it throws error.
         If not, it adds the car to purchase list (edited)
         */
